...
set(UMBRACOMPILER_CPP_EXAMPLE_TARGET UmbraCompilerCPPExample)

add_executable(${UMBRACOMPILER_CPP_EXAMPLE_TARGET}
    ${CMAKE_CURRENT_LIST_DIR}/CPP_Example.cpp
)

target_include_directories(${UMBRACOMPILER_CPP_EXAMPLE_TARGET} PRIVATE
    ${CMAKE_CURRENT_LIST_DIR}/../Source
)

target_link_libraries(${UMBRACOMPILER_CPP_EXAMPLE_TARGET} PRIVATE UmbraCompiler)

set_target_properties(${UMBRACOMPILER_CPP_EXAMPLE_TARGET} PROPERTIES
    RUNTIME_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/Example
)

if (MSVC)
    set_property(TARGET ${UMBRACOMPILER_CPP_EXAMPLE_TARGET} PROPERTY
        VS_DEBUGGER_WORKING_DIRECTORY "$<TARGET_FILE_DIR:${UMBRACOMPILER_CPP_EXAMPLE_TARGET}>"
    )
endif()

add_custom_command(TARGET ${UMBRACOMPILER_CPP_EXAMPLE_TARGET} POST_BUILD
    COMMAND ${CMAKE_COMMAND} -E copy_directory
        ${CMAKE_CURRENT_LIST_DIR}/Shaders
        $<TARGET_FILE_DIR:${UMBRACOMPILER_CPP_EXAMPLE_TARGET}>/Shaders
...
if (WIN32)
    ...
    add_custom_command(TARGET ${UMBRACOMPILER_CPP_EXAMPLE_TARGET} POST_BUILD
        COMMAND ${CMAKE_COMMAND} -E copy_if_different
            ...
            $<TARGET_FILE_DIR:${UMBRACOMPILER_CPP_EXAMPLE_TARGET}>/
